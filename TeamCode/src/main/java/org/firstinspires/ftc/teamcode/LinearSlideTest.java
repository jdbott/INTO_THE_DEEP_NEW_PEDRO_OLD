...
public class LinearSlideTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        LinearSlide linearSlide = new LinearSlide(hardwareMap, motorNames, directions, 74, 0, 12.25); // Example ticksPerInch and limits
        ...
        while (opModeIsActive()) {
            if (gamepad1.a) {
                ...
                linearSlide.moveSlidesToPositionInches(12.25);
            } else if (gamepad1.x) {
                linearSlide.moveSlidesToPositionInches(6);
            }
