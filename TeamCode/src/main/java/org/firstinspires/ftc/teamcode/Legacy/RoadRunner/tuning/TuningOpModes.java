...
public final class TuningOpModes {
    ...
    public static final Class<?> DRIVE_CLASS = MecanumDriveTeamChassis.class;
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(MecanumDriveTeamChassis.class)) {
            dvf = hardwareMap -> {
                MecanumDriveTeamChassis md = new MecanumDriveTeamChassis(hardwareMap, new Pose2d(0, 0, 0));

                List<Encoder> leftEncs = new ArrayList<>(), rightEncs = new ArrayList<>();
                List<Encoder> parEncs = new ArrayList<>(), perpEncs = new ArrayList<>();
                if (md.localizer instanceof MecanumDriveTeamChassis.DriveLocalizer) {
                    MecanumDriveTeamChassis.DriveLocalizer dl = (MecanumDriveTeamChassis.DriveLocalizer) md.localizer;
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        MecanumDriveTeamChassis.PARAMS.inPerTick,
                        MecanumDriveTeamChassis.PARAMS.maxWheelVel,
                        MecanumDriveTeamChassis.PARAMS.minProfileAccel,
                        MecanumDriveTeamChassis.PARAMS.maxProfileAccel,
                        ...
                        md.lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(MecanumDriveTeamChassis.PARAMS.kS,
                                MecanumDriveTeamChassis.PARAMS.kV / MecanumDriveTeamChassis.PARAMS.inPerTick,
                                MecanumDriveTeamChassis.PARAMS.kA / MecanumDriveTeamChassis.PARAMS.inPerTick)
                );
            };
