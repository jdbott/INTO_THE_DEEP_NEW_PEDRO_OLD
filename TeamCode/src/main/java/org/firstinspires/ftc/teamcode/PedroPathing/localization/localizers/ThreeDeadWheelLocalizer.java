...
//        par0 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "rightBack")));
//        par1 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "leftFront"))); FIX THIS NOT RIGHT!!!
...
//        perp.setDirection(DcMotorSimple.Direction.FORWARD); // JASON CHASSIS
    ...
    @Override
    public Pose getPose() {
        return new Pose(this.pose.position.x, this.pose.position.y, this.pose.heading.toDouble());
    }
    ...
    public void setStartPose(Pose setStart) {
        this.pose = new Pose2d(setStart.getX(), setStart.getY(), setStart.getHeading());
    }

    @Override
    public void setPose(Pose setPose) {
        this.pose = new Pose2d(setPose.getX(), setPose.getY(), setPose.getHeading());
    }
